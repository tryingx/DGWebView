...
@interface DGWebView ()<UIAlertViewDelegate>
...
- (void)webViewDidStartLoad:(UIWebView *)webView
{
    if(webView == self.uiWebView) {
        [self.delegate dgwebViewDidStartLoad:self];
    }
}
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if(webView == self.uiWebView) {
        ...
        if(![self externalAppRequiredToOpenURL:request.URL]) {
            ...
            //back delegate
            [self.delegate dgwebView:self shouldStartLoadWithURL:request.URL];
            return YES;
        }
        else {
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    if(webView == self.uiWebView) {
        ...
        //back delegate
        [self.delegate dgwebView:self didFinishLoadingURL:self.uiWebView.request.URL];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    ...
    if(webView == self.uiWebView) {
        ...
        //back delegate
        [self.delegate dgwebView:self didFailToLoadURL:self.uiWebView.request.URL error:error];
    }
}
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    ...
    if(webView == self.wkWebView) {
        ...
        //back delegate
        [self.delegate dgwebView:self didFinishLoadingURL:self.wkWebView.URL];
    }
}
...
- (void)webView:(WKWebView *)webView didFailProvisionalNavigation:(WKNavigation *)navigation
    ...
    if(webView == self.wkWebView) {
        //back delegate
        [self.delegate dgwebView:self didFailToLoadURL:self.wkWebView.URL error:error];
    }
